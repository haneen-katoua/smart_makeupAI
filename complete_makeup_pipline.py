...
class CompleteMakeupPipeline:
    ...
    def process(self, face_image_path: str, clothing_image_path: Optional[str] = None, 
                occasion_raw: str = 'evening', eye_strategy: str = 'Monochromatic',
                output_json: Optional[str] = None) -> Optional[Dict]:
...
def analyze_image(face_image_path: str, clothing_image_path: Optional[str] = None, 
                  occasion: str = 'evening', eye_strategy: str = 'Monochromatic',
                  output_json: Optional[str] = None, print_report: bool = True) -> Optional[Dict]:
    pipeline = CompleteMakeupPipeline()
    result = pipeline.process(face_image_path, clothing_image_path, occasion, eye_strategy, output_json)
    report = None
    if result and print_report:
        report = pipeline.print_report()
    if result is not None:
